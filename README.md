...
A.1) Gamechez'i sunucusuna ekleyen herkes bu politikaları kabul etmiş sayılır.
```
```
...
```
```
Gamechez bu maddeleri değiştirme ve düzenleme hakkını saklı tutar. 
```

# Gamechez English Privacy Policy;

```
A. Login

A.1) Anyone who adds Gamechez to their server is deemed to have accepted these policies.
```
```
...
```
```
Gamechez reserves the right to change and edit these articles. 
```
